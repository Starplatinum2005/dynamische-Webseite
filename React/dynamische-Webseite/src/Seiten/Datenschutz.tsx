import './stylesheets/Datenschutz.css'
...
export function Datenschutz (){
    ...
    <main className='main_Datenschutz'>
        ...
        <p>
            ...
            Seestraße 12
            <br/>
            89518, Heidenheim an der Brenz, Deutschland
            <br/>
            Geschäftsführer Maximilian Fischer
            <br/>
            Fax: 0711 918 32 23
            <br/>
            E-Mail-Adresse: Maximilian.fischer@email.co
            <br/>
            <br/>
        </p>
    ...
    <ol className="liste">
        <li><strong>Widerspruch oder Widerruf gegen die Verarbeitung Ihrer Daten<br/><br/>
            ...
            Blue Ocean Dive<br/>
            Seestraße 12<br/>
            89518, Heidenheim an der Brenz, Deutschland<br/>
            Geschäftsführer Maximilian Fischer<br/>
            Fax: 07119183223<br/>
            E-Mail-Adresse: <br/>
            </strong>  
            <br/>
        ...
        <li><strong>Recht auf Auskunft</strong><br/>
            Sie haben ein Recht auf Auskunft über Ihre bei uns gespeicherten persönlichen Daten nach Art. 15 DS-GVO. Dies beinhaltet insbesondere die Auskunft über die Verarbeitungszwecke, die Kategorie der personenbezogenen Daten, die Kategorien von Empfängern, gegenüber denen Ihre Daten offengelegt wurden oder werden, die geplante Speicherdauer, die Herkunft ihrer Daten, sofern diese nicht direkt bei Ihnen erhoben wurden.<br/><br/>
        </li>
        <li><strong>Recht auf Berichtigung</strong><br/>
            Sie haben ein Recht auf Berichtigung unrichtiger oder auf Vervollständigung richtiger Daten nach Art. 16 DS-GVO.<br/><br/>
        </li>
        ...
        <li><strong>Recht auf Beschwerde</strong><br/>
            Sie haben ein Recht auf Beschwerde bei einer Aufsichtsbehörde. In der Regel können Sie sich hierfür an die Aufsichtsbehörde insbesondere in dem Mitgliedstaat ihres Aufenthaltsorts, ihres Arbeitsplatzes oder des Orts des mutmaßlichen Verstoßes wenden.<br/><br/>
        </li>
    </ol>
