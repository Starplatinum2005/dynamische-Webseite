  ...
  return (
    <main className="überuns">
      ...
      <article className="section-container">
        <img src="/taucher_korallenriff.png" alt="Unsere Mission" className="section-Bild" />
      ...
      <article className="section-container">
        ...
        <img src="/tauchladen.png" alt="Tauchladen Blue Ocean Dive" className="section-Bild" />
      </article>

      <article className="section-container">
        <img src="/gruppenfoto_überuns.png" alt="Gruppenfoto unserer Tauchlehrer an einem Strand" className="section-Bild" />
        <section className="section-Inhalt">
          <h2>Unser Team</h2>
      ...
      <article className="section-container">
        ...
        <img src="/philosophie_überuns.png" alt="Zwei Taucher unter Wasser mit modernster Tauchausrüstung" className="section-Bild" />
      </article>
